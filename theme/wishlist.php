...
<div class="max-w-[87.5rem] mx-auto">
    <div class="mx-12 md:mx-4 mb-36 md:mb-32 mt-5 md:mt-2.5">
        <header id="heading-section mb-4">
            <h1 class="w-full heading-md text-deep-dark-gray mb-4"><?php echo wp_kses_post("Norų sąrašas"); ?></h1>
        </header>

        <?php if (!empty($wishlist_items)): ?>
            <div class="wishlist-items grid grid-cols-3 gap-8 md:gap-4">
                <?php foreach ($wishlist_items as $product_id): ?>
                    ...
                    <div class="product-card flex flex-col col-span-1 md:col-span-2">
        ...
        <?php else: ?>
            <p class="body-small-regular text-deep-dark-gray mt-10">
                <?php echo wp_kses_post("Jūsų norų sąrašas tuščias."); ?></p>
        <?php endif; ?>
    </div>
</div>
