    ...
    <main id="main" class="mx-12 md:mx-4 mb-36 md:mb-32 mt-5 md:mt-2.5">
        ...
        <div
            ...
            <a href="<?php echo get_permalink(get_option('page_for_posts')); ?>"
                class="filter-button link-active hover:text-deep-dark-gray link-hover whitespace-nowrap"><?php echo wp_kses_post("Rodyti viską") ?></a>
            <?php
            $uncategorized = null;
                    ...
                    <article id="post-<?php the_ID(); ?>" <?php post_class("$col_span_class md:col-span-12 blog-post mb-5 archive-blog-post"); ?>>
                        ...
                        <a href="<?php the_permalink(); ?>" class="block">
                            <?php if (has_post_thumbnail()): ?>
                                <div class="post-thumbnail mb-5 rounded-lg <?php echo $aspect_ratio_class; ?>">
