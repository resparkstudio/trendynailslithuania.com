...
`;
  ...
  // javascript/ajax-add-to-cart.js
  document.addEventListener("DOMContentLoaded", function() {
      ...
      jQuery.ajax({
        ...
        success: function(response) {
          if (response.success) {
            ...
            createNotification(
              response.data.message || "Nepavyko pa\u0161alinti \u012F krep\u0161el\u012F",
              false
            );
          }
        },
    ...
    jQuery(document).on("click", ".remove_from_cart_button", function(event2) {
      event2.preventDefault();
  ...
  // javascript/ajax-checkout.js
  jQuery(document).ready(function($) {
    console.log("Custom quantity script loaded");
