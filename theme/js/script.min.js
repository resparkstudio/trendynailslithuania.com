(() => {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    gsapWithCSS.set(sidebarCloseLink, {
      opacity: 0,
      display: "none",
      visibility: "hidden"
    });
    ...
    sidebarOpenLinks.forEach((link) => {
      link.addEventListener("click", function(e) {
        ...
        gsapWithCSS.set(sidebar, { display: "grid", visibility: "visible" });
        ...
        gsapWithCSS.to(sidebarCloseLink, {
          duration: 0.1,
          opacity: 1,
          ease: "power2.out",
          onComplete: () => {
      ...
      jQuery.ajax({
        ...
        success: function(response) {
          if (response.success) {
            ...
            createNotification(
              response.data.message || "Nepavyko prid\u0117ti \u012F nor\u0173 s\u0105ra\u0161\u0105.",
              false
            );
          }
        },
