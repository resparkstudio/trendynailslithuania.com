(() => {
  ...
  var require_jquery = __commonJS({
    "node_modules/jquery/dist/jquery.js"(exports, module) {
      (function(global, factory) {
        ...
        var version = "3.7.1", rhtmlSuffix = /HTML$/i, jQuery3 = function(selector3, context3) {
          return new jQuery3.fn.init(selector3, context3);
        };
        ...
        (function() {
          ...
          find.contains = function(context3, elem) {
            ...
            return jQuery3.contains(context3, elem);
          };
        ...
        jQuery3.fn.extend({
          find: function(selector3) {
            ...
            if (typeof selector3 !== "string") {
              return this.pushStack(jQuery3(selector3).filter(function() {
                for (i = 0; i < len; i++) {
            ...
            ret = this.pushStack([]);
            for (i = 0; i < len; i++) {
              jQuery3.find(selector3, self[i], ret);
            }
          ...
          is: function(selector3) {
            return !!winnow(
              ...
              typeof selector3 === "string" && rneedsContext.test(selector3) ? jQuery3(selector3) : selector3 || [],
              false
            ).length;
          }
        });
        var rootjQuery, rquickExpr = /^(?:\s*(<[\w\W]+>)[^>]*|#([\w-]+))$/, init4 = jQuery3.fn.init = function(selector3, context3, root) {
          var match, elem;
          if (!selector3) {
            return this;
          }
          ...
          if (typeof selector3 === "string") {
            ...
            if (match && (match[1] || !context3)) {
              if (match[1]) {
                context3 = context3 instanceof jQuery3 ? context3[0] : context3;
                jQuery3.merge(this, jQuery3.parseHTML(
                  match[1],
                  context3 && context3.nodeType ? context3.ownerDocument || context3 : document2,
                  true
                ));
                if (rsingleTag.test(match[1]) && jQuery3.isPlainObject(context3)) {
          ...
          return jQuery3.makeArray(selector3, this);
        };
        init4.prototype = jQuery3.fn;
        ...
        jQuery3.fn.extend({
          ...
          add: function(selector3, context3) {
            return this.pushStack(
              jQuery3.uniqueSort(
                jQuery3.merge(this.get(), jQuery3(selector3, context3))
              )
            );
          },
        ...
        jQuery3.each({
          ...
          jQuery3.fn[name] = function(until, selector3) {
            var matched = jQuery3.map(this, fn, until);
            if (name.slice(-5) !== "Until") {
              selector3 = until;
            }
            if (selector3 && typeof selector3 === "string") {
              matched = jQuery3.filter(selector3, matched);
            }
            if (this.length > 1) {
        ...
        function getAll(context3, tag) {
          ...
          if (tag === void 0 || tag && nodeName(context3, tag)) {
            return jQuery3.merge([context3], ret);
          }
          return ret;
        }
          ...
          for (; i < l; i++) {
            ...
            if (elem || elem === 0) {
              if (toType(elem) === "object") {
                ...
                tmp.innerHTML = wrap3[1] + jQuery3.htmlPrefilter(elem) + wrap3[2];
                j = wrap3[0];
                while (j--) {
                  tmp = tmp.lastChild;
                }
        ...
        function on(elem, types, selector3, data, fn, one) {
          ...
          return elem.each(function() {
            jQuery3.event.add(this, types, fn, data, selector3);
          });
        }
        jQuery3.event = {
          global: {},
          add: function(elem, types, handler, data, selector3) {
            ...
            if (selector3) {
              jQuery3.find.matchesSelector(documentElement, selector3);
            }
            if (!handler.guid) {
            ...
            while (t--) {
              ...
              handleObj = jQuery3.extend({
                ...
                guid: handler.guid,
                selector: selector3,
                needsContext: selector3 && jQuery3.expr.match.needsContext.test(selector3),
          ...
          remove: function(elem, types, handler, selector3, mappedTypes) {
            ...
            while (t--) {
              ...
              if (!type) {
                for (type in events2) {
                  jQuery3.event.remove(elem, type + types[t], handler, selector3, true);
                }
                continue;
              }
              special = jQuery3.event.special[type] || {};
            ...
            if (jQuery3.isEmptyObject(events2)) {
        ...
        jQuery3.fn.extend({
          ...
          off: function(types, selector3, fn) {
            ...
            return this.each(function() {
              jQuery3.event.remove(this, types, fn, selector3);
            });
          }
        });
            ...
            if (events2) {
              ...
              for (type in events2) {
                for (i = 0, l = events2[type].length; i < l; i++) {
                  jQuery3.event.add(dest, type, events2[type][i]);
                }
              }
            }
          }
        ...
        function remove(elem, selector3, keepData) {
          var node, nodes = selector3 ? jQuery3.filter(selector3, elem) : elem, i = 0;
        ...
        jQuery3.extend({
          ...
          clone: function(elem, dataAndEvents, deepDataAndEvents) {
            ...
            if (!support2.noCloneChecked && (elem.nodeType === 1 || elem.nodeType === 11) && !jQuery3.isXMLDoc(elem)) {
        ...
        jQuery3.each({
          ...
          jQuery3.fn[name] = function(selector3) {
            var elems, ret = [], insert = jQuery3(selector3), last = insert.length - 1, i = 0;
            for (; i <= last; i++) {
        ...
        function getWidthOrHeight(elem, dimension, extra) {
          var styles = getStyles(elem), boxSizingNeeded = !support2.boxSizingReliable() || extra, isBorderBox = boxSizingNeeded && jQuery3.css(elem, "boxSizing", false, styles) === "border-box", valueIsBorderBox = isBorderBox, val = curCSS(elem, dimension, styles), offsetProp = "offset" + dimension[0].toUpperCase() + dimension.slice(1);
        ...
        jQuery3.each(["height", "width"], function(_i, dimension) {
          jQuery3.cssHooks[dimension] = {
            ...
            set: function(elem, value, extra) {
              var matches, styles = getStyles(elem), scrollboxSizeBuggy = !support2.scrollboxSize() && styles.position === "absolute", boxSizingNeeded = scrollboxSizeBuggy || extra, isBorderBox = boxSizingNeeded && jQuery3.css(elem, "boxSizing", false, styles) === "border-box", subtract = extra ? boxModelAdjustment(
                elem,
                dimension,
                extra,
                isBorderBox,
        ...
        jQuery3.fx = Tween2.prototype.init;
        jQuery3.fx.step = {};
        ...
        function Animation2(elem, properties, options) {
          var result, stopped, index = 0, length = Animation2.prefilters.length, deferred = jQuery3.Deferred().always(function() {
            delete tick.elem;
          }), tick = function() {
            if (stopped) {
              return false;
        ...
        jQuery3.Animation = jQuery3.extend(Animation2, {
          tweeners: {
            "*": [function(prop, value) {
        ...
        jQuery3.fn.extend({
          ...
          animate: function(prop, speed, easing, callback) {
            var empty = jQuery3.isEmptyObject(prop), optall = jQuery3.speed(speed, easing, callback), doAnimation = function() {
              var anim = Animation2(this, jQuery3.extend({}, prop), optall);
        ...
        jQuery3.fn.extend({
          wrapAll: function(html) {
            ...
            if (this[0]) {
              ...
              wrap3 = jQuery3(html, this[0].ownerDocument).eq(0).clone(true);
        ...
        jQuery3.parseHTML = function(data, context3, keepScripts) {
          if (typeof data !== "string") {
            return [];
          }
          ...
          if (self.length > 0) {
            jQuery3.ajax({
              ...
              self.html(selector3 ? (
                ...
                jQuery3("<div>").append(jQuery3.parseHTML(responseText)).find(selector3)
              ) : (
        ...
        jQuery3.proxy = function(fn, context3) {
          var tmp, args, proxy;
        ...
        $.extend($.validator, {
          defaults: {
            ...
            onkeyup: function(element, event2) {
              ...
              if (event2.which === 9 && this.elementValue(element) === "" || $.inArray(event2.keyCode, excludedKeys) !== -1) {
                return;
          ...
          prototype: {
            init: function() {
              ...
              function delegate(event2) {
                ...
                var validator = $.data(this.form, "validator"), eventType = "on" + event2.type.replace(/^validate/, ""), settings = validator.settings;
            ...
            errorsFor: function(element) {
              var name = this.escapeCssMeta(this.idOrName(element)), describer = $(element).attr("aria-describedby"), selector3 = "label[for='" + name + "'], label[for='" + name + "'] *";
              if (describer) {
          ...
          classRules: function(element) {
            var rules = {}, classes2 = $(element).attr("class");
            if (classes2) {
              $.each(classes2.split(" "), function() {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    gsapWithCSS.set(sidebar, { x: "-100%", display: "none" });
    gsapWithCSS.set(sidebarOpenedShopLink, {
      opacity: 0,
      display: "none",
      visibility: "hidden"
    });
    const sidebarTimeline = gsapWithCSS.timeline({ paused: true });
    sidebarTimeline.set(sidebar, { display: "grid", visibility: "visible" }).to(sidebar, { duration: 0.5, x: "0%", ease: "power2.out" }, 0).set(
    ...
    sidebar.addEventListener("mouseleave", function(e) {
      if (window.innerWidth >= 767) {
        ...
        if (safeDiv && (relatedTarget === safeDiv || safeDiv.contains(relatedTarget))) {
          return;
        }
        e.preventDefault();
        toggleSidebar(false);
    ...
    document.addEventListener("click", (event2) => {
      if (sidebarOpen && !sidebar.contains(event2.target) && event2.target !== mobileSidebarOpenLink) {
        toggleSidebar(false);
      }
    });
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById("currentYear").textContent = (/* @__PURE__ */ new Date()).getFullYear();
  });
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    gsapWithCSS.set(cursor, { xPercent: -50, yPercent: -50, autoAlpha: 0, scale: 0 });
    let xTo = gsapWithCSS.quickTo(cursor, "x", { duration: 0.15, ease: "power3" });
    let yTo = gsapWithCSS.quickTo(cursor, "y", { duration: 0.15, ease: "power3" });
    function handleCursor() {
      if (window.innerWidth >= 1023) {
        ...
        gsapWithCSS.set(cursor, { autoAlpha: 0 });
  ...
  // javascript/single-product-desc.js
  var expandElements = document.querySelectorAll(".info-expand");
  ...
  expandElements.forEach((expandElement, index) => {
    ...
    expandElement.addEventListener("click", () => {
      ...
      if (isExpanded) {
        ...
        gsapWithCSS.to(plusIconWrap, {
          rotation: 180,
          ease: "power1.out",
          duration: 0.4
        });
        gsapWithCSS.to(plusStripeV, {
          opacity: 0,
          ease: "power1.out",
          duration: 0.4
        });
      } else {
        gsapWithCSS.to(infoTextElement, {
          height: 0,
          opacity: 0,
          y: 20,
          ease: "power1.out",
  ...
  // javascript/notificationBanner.js
  function createNotification(message, isSuccess = true) {
    ...
    const iconSvg = isSuccess ? `<svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`;
  ...
  // javascript/ajax-checkout-and-cart.js
  document.addEventListener("DOMContentLoaded", function() {
    ...
    function updateAllCarts(response) {
      if (response.success) {
        ...
        if (response.data.cart_count !== void 0) {
          const cartCountElement2 = document.getElementById("cart-count");
          if (cartCountElement2) {
            cartCountElement2.textContent = response.data.cart_count;
          }
        }
    ...
    jQuery(document).on(
      ...
      function(event2) {
        ...
        if (quantityInput.length && $button.is("#single-product-add-to-cart")) {
    ...
    jQuery("#discount-code").on("keydown", function(event2) {
      if (event2.key === "Enter") {
        event2.preventDefault();
    ...
    jQuery(document).on(
      ...
      function(event2) {
        event2.preventDefault();
        const $button = jQuery(this);
        const cartItemKey = $button.data("remove-item") || $button.data("cart_item_key");
        const productName = $button.data("product_name");
  ...
  // javascript/archive-products.js
  document.addEventListener("DOMContentLoaded", function() {
  ...
  function fetchSortedProducts(orderby, category) {
    ...
    fetch(ajaxUrl).then((response) => response.json()).then((data) => {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    searchBoxContainer.addEventListener("keydown", (event2) => {
      if (event2.key === "Escape" && searchToggle) {
        searchToggle = false;
        closeSearchBox();
      }
    });
    function initSearchBox() {
      gsapWithCSS.set(searchBoxContainer, {
        opacity: 0,
        y: -70
      });
    }
    function openSearchBox() {
      ...
      gsapWithCSS.to(searchBoxContainer, {
        duration: 0.3,
        opacity: 1,
        y: 0,
        ease: "power2.out",
  ...
  document.addEventListener("DOMContentLoaded", function() {
        ...
        success: function(response) {
          if (response.success) {
            ...
            if (wishlistCountElement) {
              wishlistCountElement.textContent = response.data.wishlist_count;
            }
          }
        }
      });
      ...
      jQuery.ajax({
        ...
        success: function(response) {
          if (response.success) {
            ...
            createNotification(
              response.data.message || "Nepavyko atnaujinti nor\u0173 s\u0105ra\u0161o.",
              false
            );
          }
        },
      ...
      jQuery.ajax({
        ...
        success: function(response) {
          if (response.success) {
            ...
            createNotification(
              response.data.message || "Nepavyko pa\u0161alinti i\u0161 nor\u0173 s\u0105ra\u0161o.",
              false
            );
          }
        },
    ...
    jQuery(document).on("click", ".add-to-wishlist-btn", function(event2) {
      event2.preventDefault();
      const button = this;
    ...
    jQuery(document).on("click", ".remove-from-wishlist-btn", function(event2) {
      event2.preventDefault();
      const button = this;
      const productId = jQuery(button).data("product_id");
      const productName = jQuery(button).data("product_name");
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    gsapWithCSS.set(successModal, { opacity: 0 });
    document.addEventListener(
      "wpcf7mailsent",
      function(event2) {
        if (event2.detail.contactFormId === 351) {
          gsapWithCSS.fromTo(
            successModal,
            { opacity: 0 },
    ...
    function closeModal() {
      gsapWithCSS.to(successModal, {
        opacity: 0,
        duration: 0.3,
        ease: "power2.out",
        onComplete: () => successModal.classList.add("hidden")
        // Hide after animation
      });
    }
    closeModalButton.addEventListener("click", closeModal);
    window.addEventListener("click", function(event2) {
      if (event2.target === successModal) {
        closeModal();
      }
    });
  });

  // javascript/product-image-hover.js
  document.addEventListener("DOMContentLoaded", function() {
    ...
    productImages.forEach((container) => {
      ...
      if (galleryImage) {
        container.addEventListener("mouseenter", () => {
          gsapWithCSS.to(originalImage, {
            opacity: 0,
            duration: 0.2,
            ease: "none"
          });
          gsapWithCSS.to(galleryImage, {
            opacity: 1,
            duration: 0.2,
            ease: "none"
          });
  ...
  // javascript/ajax-product-archive-load.js
  document.addEventListener("DOMContentLoaded", function() {
    let page = 2;
    let loading = false;
    ...
    const category = productList ? productList.getAttribute("data-category") : null;
      ...
      if (window.innerHeight + window.scrollY >= document.body.offsetHeight - 500 && !loading) {
        ...
        fetch(woocommerce_params.ajax_url, {
          ...
          if (response == "0") {
            ...
            page++;
            loading = false;
            const newProducts = container.querySelectorAll("li.product-card");
  ...
  // javascript/ajax-discount-code.js
  document.addEventListener("DOMContentLoaded", () => {
    ...
    function fetchCartSummaryDetails() {
      jQuery.ajax({
        ...
        type: "POST",
        data: {
          action: "fetch_cart_summary"
          // Custom WooCommerce action
        },
        success: function(response) {
  ...
  // javascript/dynamic-shipping-pick-up.js
  document.addEventListener("DOMContentLoaded", function() {
  ...
  // javascript/dynamic-payment-option.js
  function adjustPayseraOptions() {
    ...
    if (payseraOptionsWrapper) {
      ...
      payseraOptions.forEach((option) => {
        ...
        newLi.className = "flex gap-x-2 items-center wc_payment_method paysera_sub_option";
  ...
  // javascript/newsletter-toggle.js
  document.addEventListener("DOMContentLoaded", function() {
    ...
    openButton.addEventListener("click", function(event2) {
      event2.stopPropagation();
    ...
    document.addEventListener("click", function(event2) {
      if (!innerAside.contains(event2.target) && aside.classList.contains("right-0")) {
        closeNewsletterPopup();
      }
    });
    overlay.addEventListener("click", function(event2) {
      if (!innerAside.contains(event2.target)) {
        closeNewsletterPopup();
      }
    });
  ...
  // javascript/checkout-validation.js
    ...
    $(document).ready(function() {
      $.validator.addMethod(
        ...
        function(value, element) {
          return this.optional(element) || /^\+[\d\s\-()]{7,11}$/.test(value);
        },
        'Telefono numeris turi prasid\u0117ti "+" \u017Eenklu ir b\u016Bti ne ilgesnis nei 11 skaitmen\u0173.'
      ...
      const validationRules = {
        ...
        messages: {
          billing_first_name: "<strong>Vardas</strong> yra b\u016Btinas laukelis.",
          billing_last_name: "<strong>Pavard\u0117</strong> yra b\u016Btinas laukelis.",
          billing_address_1: "<strong>Gatv\u0117, namo numeris</strong> yra b\u016Btinas laukelis.",
          billing_city: "<strong>Miestas</strong> yra b\u016Btinas laukelis.",
          billing_email: {
            required: "<strong>El. pa\u0161tas</strong> yra b\u016Btinas laukelis.",
            validEmail: "\u012Evestas el. pa\u0161to adresas neteisingas."
            // Custom error message
          },
          billing_phone: {
            required: "<strong>Telefonas</strong> yra b\u016Btinas laukelis.",
            validPhone: 'Telefono numeris turi prasid\u0117ti "+" \u017Eenklu ir b\u016Bti ne ilgesnis nei 11 skaitmen\u0173.'
            // Updated message
          },
          billing_postcode: "<strong>Pa\u0161to kodas</strong> yra b\u016Btinas laukelis.",
        ...
        errorPlacement: function(error, element) {
          if (element.attr("type") === "checkbox") {
            ...
            const labelElement = element.closest(".form-row").find("label");
        ...
        unhighlight: function(element) {
          ...
          $(element).closest(".form-row").css("color", "").find(".error-wrapper").remove();
        }
      };
  ...
  // javascript/wishlistlist-active-heart.js
  document.addEventListener("DOMContentLoaded", function() {
  ...
  // javascript/move-omnisend-checkbox.js
  jQuery(document).ready(function($) {
