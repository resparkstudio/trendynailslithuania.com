...
`;
  ...
  // javascript/single-product-duk.js
  document.addEventListener("DOMContentLoaded", () => {
    ...
    faqItems.forEach((item) => {
      ...
      gsapWithCSS.set(answer, { height: 0, overflow: "hidden", opacity: 0 });
      question.addEventListener("click", () => {
        const isOpen = item.classList.contains("open");
        faqItems.forEach((otherItem) => {
          if (otherItem !== item && otherItem.classList.contains("open")) {
            const otherAnswer = otherItem.querySelector(".duk-answer");
            const otherArrow = otherItem.querySelector("svg:last-child");
            otherItem.classList.remove("open");
            gsapWithCSS.to(otherAnswer, {
              height: 0,
              opacity: 0,
              duration: 0.5,
              ease: "power2.out",
        ...
        if (!isOpen) {
          ...
          gsapWithCSS.fromTo(
            ...
            { height: 0, opacity: 0 },
            {
              ...
              duration: 0.5,
              ease: "power2.out",
              onComplete: () => gsapWithCSS.set(answer, { height: "auto" })
