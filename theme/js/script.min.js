...
`;
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll(
      ...
      button.addEventListener("click", function(event2) {
        ...
        if (quantityInput && button.id === "single-product-add-to-cart") {
  ...
  document.addEventListener("DOMContentLoaded", function() {
    ...
    closeButton.addEventListener("click", function(event2) {
      event2.stopPropagation();
      gsapWithCSS.to(aside, { right: "-36rem", duration: 0.5, ease: "power2.in" });
    });
    document.addEventListener("click", function(event2) {
      if (!innerAside.contains(event2.target) && parseInt(getComputedStyle(aside).right) === 0) {
        gsapWithCSS.to(aside, {
          right: "-36rem",
          duration: 0.5,
          ease: "power2.in"
      ...
      const validationRules = {
        ...
        errorPlacement: function(error, element) {
          if (element.attr("type") === "checkbox") {
            ...
            const labelElement = element.closest(".form-row").find(".checkout-form-label");
