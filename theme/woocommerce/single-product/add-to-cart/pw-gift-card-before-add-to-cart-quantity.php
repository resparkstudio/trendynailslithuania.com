...
<style>
    ...
    .woocommerce.single .woocommerce-variation-add-to-cart>style {
        display: none;
    }
...
<div id="pwgc-purchase-container" style="<?php echo $selected ? '' : 'display: none;'; ?>">
    <div class="pwgc-field-container">
        ...
        <input type="text" id="pwgc-to" name="<?php echo PWGC_TO_META_KEY; ?>" class="pwgc-input-text checkout-form-input" placeholder="<?php _e('Enter an email address for each recipient', 'pw-woocommerce-gift-cards'); ?>" value="<?php echo $pwgc_to; ?>" required>
    ...
    <div class="pwgc-field-container">
        ...
        <input type="text" id="pwgc-from" name="<?php echo PWGC_FROM_META_KEY; ?>" class="pwgc-input-text checkout-form-input" placeholder="<?php _e('Your name', 'pw-woocommerce-gift-cards'); ?>" value="<?php echo $pwgc_from; ?>" required>
    </div>

    <div class="pwgc-field-container hidden">
