...
if ($related_products_query->have_posts()): ?>
	...
	<section class="relative mt-28 lg:mt-16">
		...
		<div class="swiper-container overflow-hidden related-products-swiper-container">
					...
					<div class="swiper-slide">
						<div class="product-card flex flex-col">
							<div class="w-full relative mb-4 lg:mb-3 product-image-container">
								...
								$is_in_wishlist = in_array($related_product_id, $wishlist); // Check if the product is in the wishlist
								?>
		...
		<!-- Swiper Navigation -->
		<div
			class="product-nav-button-prev related-products-nav-button-prev absolute left-[-1.21875rem] z-20 cursor-pointer">
		...
		<div
			class="product-nav-button-next related-products-nav-button-next absolute right-[-1.21875rem] z-20 cursor-pointer">
			<svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path
					d="M6 5L0.746059 -3.26113e-08L-4.06079e-07 0.71L1.80736 2.42L4.51839 5L1.80736 7.58L0.0105077 9.29L0.756567 10L6 5Z"
					fill="black" />
...
<?php if ($new_products_query->have_posts()): ?>
	<section id="new-products-section" class="mt-20 relative">
		...
		<!-- Swiper Navigation -->
		<div class="product-nav-button-prev new-products-nav-button-prev absolute left-[-1.21875rem] z-20 cursor-pointer">
			<svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path
					d="M-6.95394e-07 5L5.25394 10L6 9.29L4.19264 7.58L1.48161 5L4.19264 2.42L5.98949 0.71L5.24343 -3.30706e-08L-6.95394e-07 5Z"
					fill="black" />
		...
		<div class="product-nav-button-next new-products-nav-button-next absolute right-[-1.21875rem] z-20 cursor-pointer">
			<svg width="6" height="10" viewBox="0 0 6 10" fill="none" xmlns="http://www.w3.org/2000/svg">
				<path
					d="M6 5L0.746059 -3.26113e-08L-4.06079e-07 0.71L1.80736 2.42L4.51839 5L1.80736 7.58L0.0105077 9.29L0.756567 10L6 5Z"
					fill="black" />
