...
?>
<li class="flex gap-x-2 items-center wc_payment_method payment_method_<?php echo esc_attr($gateway->id); ?>">
	<input id="payment_method_<?php echo esc_attr($gateway->id); ?>" type="radio"
		class="input-radio custom-radio shrink-0" name="payment_method" value="<?php echo esc_attr($gateway->id); ?>"
