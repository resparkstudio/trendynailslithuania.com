<!-- -->
<aside
    class="fixed inset-y-0 right-[-36rem]  sm:right-[-100vw]  flex items-end mb-28 justify-center bg-pink-50 z-20 rounded-l-[10px]">
    <div class="inner-aside flex relative">
        <!-- Rotated Button -->
        <a
            class="newsletter-button-outer absolute top-[59px] left-[-30px] -translate-y-1/2 w-[41px] z-10 bg-black rounded-l-[5px] pl-[0.375rem]">
            <div
        ...
        <div
            class="bg-white flex items-center z-20 w-[36rem] sm:w-screen text-deep-dark-gray rounded-l-[10px] relative">
