...
// Overwrite all WooCommerce strings with Lithuanian translations
add_filter('gettext', 'translate_woocommerce_strings_to_lithuanian', 999);
add_filter('ngettext', 'translate_woocommerce_strings_to_lithuanian', 999);

function translate_woocommerce_strings_to_lithuanian($translated)
{
	$translations = [
		// Field labels
		'First name' => 'Vardas',
		...
		'Apartment, suite, unit, etc. (optional)' => 'Butas, apartamentai, įrenginys ir t.t. (neprivaloma)',
		'Town / City' => 'Miestas',
		'State / County' => 'Valstija / Apskritis',
		'Postcode / ZIP' => 'Pašto kodas',
		'Phone' => 'Telefonas',
		'Email address' => 'El. pašto adresas',
		'Create an account?' => 'Sukurti paskyrą?',
		'Additional information' => 'Papildoma informacija',
		'Order notes (optional)' => 'Užsakymo pastabos (neprivaloma)',
		'House number and street name' => 'Namo numeris ir gatvės pavadinimas',

		// Validation messages
		'is a required field.' => 'yra privalomas laukas.',
		'Please enter a valid email address.' => 'Įveskite galiojantį el. pašto adresą.',
		'Invalid payment method.' => 'Netinkamas mokėjimo būdas.',
		'Billing details' => 'Apmokėjimo informacija',
		'Your order' => 'Jūsų užsakymas',
		'Place order' => 'Patvirtinti užsakymą',
		'This password reset key is for a different user account. Please log out and try again.' => 'Šis slaptažodžio atkūrimo raktas yra skirtas kitai naudotojo paskyrai. Atsijunkite ir bandykite dar kartą.',
		'Please enter a valid Eircode.' => 'Įveskite galiojantį Eircode.',
		'Please enter a valid postcode / ZIP.' => 'Įveskite galiojantį pašto kodą.',
		'Address changed successfully.' => 'Adresas atnaujintas sėkmingai.',
		'Display name cannot be changed to email address due to privacy concern.' => 'Rodymo vardo negalima pakeisti į el. pašto adresą dėl privatumo.',
		'Display name' => 'Rodymo vardas',
		'This email address is already registered.' => 'Šis el. pašto adresas jau užregistruotas.',
		'Please fill out all password fields.' => 'Užpildykite visus slaptažodžio laukus.',
		'Please enter your current password.' => 'Įveskite dabartinį slaptažodį.',
		'Please re-enter your password.' => 'Pakartotinai įveskite slaptažodį.',
		'New passwords do not match.' => 'Nauji slaptažodžiai nesutampa.',
		'Your current password is incorrect.' => 'Jūsų dabartinis slaptažodis neteisingas.',
		'Account details changed successfully.' => 'Paskyros informacija sėkmingai pakeista.',
		'You cannot add a new payment method so soon after the previous one. Please wait for %d second.' => 'Negalite pridėti naujo mokėjimo metodo taip greitai po ankstesnio. Palaukite %d sekundę.',
		'You cannot add a new payment method so soon after the previous one. Please wait for %d seconds.' => 'Negalite pridėti naujo mokėjimo metodo taip greitai po ankstesnio. Palaukite %d sekundžių.',
		'Invalid payment gateway.' => 'Neteisingas mokėjimo šliuzas.',
		'Payment method successfully added.' => 'Mokėjimo metodas sėkmingai pridėtas.',
		'Unable to add payment method to your account.' => 'Nepavyko pridėti mokėjimo metodo prie jūsų paskyros.',
		'Payment method deleted.' => 'Mokėjimo metodas ištrintas.',
		'This payment method was successfully set as your default.' => 'Šis mokėjimo metodas sėkmingai nustatytas kaip numatytasis.',
		...
		'Downloads' => 'Atsisiuntimai',
		'Addresses' => 'Adresai',
		'Account details' => 'Paskyros nustatymai',
		'changed successfully' => 'atnaujinti sėkmingai',
		'Logout' => 'Atsijungti',
	...
	return str_ireplace(array_keys($translations), array_values($translations), $translated);
}


// Translate "(optional)" for dynamically added checkout fields
add_filter('woocommerce_form_field', 'translate_optional_text_to_lithuanian', 999, 4);

function translate_optional_text_to_lithuanian($field, $key, $args, $value)
{
	$field = str_ireplace('(optional)', '(neprivaloma)', $field);
	return $field;
}